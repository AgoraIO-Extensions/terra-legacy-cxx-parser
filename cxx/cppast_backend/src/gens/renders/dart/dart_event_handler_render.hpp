#ifndef DART_EVENT_HANDLER_RENDER_H_
#define DART_EVENT_HANDLER_RENDER_H_
...
class DartEventHandlerRender : public DartCallApiRender
{
...
public:
    ...
    virtual SyntaxRender::RenderedBlock RenderIncludeDirectives(const CXXFile &file, const std::vector<IncludeDirective> &include_directives) override
    {
        ...
        dart_import += "import 'package:agora_rtc_engine/src/impl/event_loop.dart';\n";
...
#endif // DART_EVENT_HANDLER_RENDER_H_