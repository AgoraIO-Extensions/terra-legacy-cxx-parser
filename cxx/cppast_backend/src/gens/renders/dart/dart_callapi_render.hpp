#ifndef DART_CALLAPI_RENDER_H_
#define DART_CALLAPI_RENDER_H_
...
class DartCallApiRender : public DartSyntaxRender
{
...
public:
    ...
    SyntaxRender::RenderedBlock RenderMemberVariable(const NodeType &parent, const MemberVariable &member_variable) override
    {
        ...
        SyntaxRender::RenderedBlock rendered_block; // = DartSyntaxRender::RenderMemberVariable(member_variable);
        // std::string dart_member = "";
        // dart_member += "@JsonKey(name: '" + member_variable.name + "')\n";
        // dart_member += rendered_block.rendered_content;
    ...
    SyntaxRender::RenderedBlock RenderClass(const Clazz &original_clazz, const std::vector<SyntaxRender::RenderedBlock> &rendered_class_members) override
    {
        ...
        // dart_class += "String get apiTypePrefix => isOverrideClassName ? className : '" + api_type + "';\n";
        // dart_class += "\n";
    ...
    SyntaxRender::RenderedBlock RenderMemberFunction(const NodeType &parent, const MemberFunction &member_function) override
    {
        ...
        dart_function += comment_prefix + "final callApiResult = " + await_keyword + " apiCaller.callIrisApi(apiType, jsonEncode(param), buffers:" + buffer + ");\n";
        // dart_function += "return apiCaller.callApi<" + return_type + ">(apiType, jsonEncode(param));\n";
